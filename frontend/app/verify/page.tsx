            ...
            <div className="w-full max-w-lg">
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8">
                    <form onSubmit={handleVerify} className="space-y-6">
                        ...
                        {/* Challenge ID Input */}
                        <div className="space-y-2">
                            <label htmlFor="challengeId" className="text-sm font-medium text-gray-700 flex items-center">
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-blue-700">
                                Make sure you have the correct challenge ID from your send-otp request.
                                OTP codes expire after 5 minutes and have a maximum of 5 attempts.
                            </p>
                        </div>
                    </div>
                </div>
